...
- **fix**: Mobile menu CSS positioning conflicts - resolved transform/visibility issues

- **fix**: Hamburger menu click functionality - removed undefined handleScroll error

- **fix**: Z-index hierarchy for clickable elements - proper stacking order

- **fix**: Mobile breakpoint increased to 900px for landscape phone support

- **fix**: Added landscape orientation CSS for better mobile experience

- **fix**: Includes.js race condition - set __includesReady flag before event dispatch

- **fix**: Removed inline onclick handlers from mobile navigation

- **fix**: Added safe-area insets for notched devices (iPhone X+)

- **fix**: Programs grid overflow on narrow screens (iPhone SE)

- **fix**: Mobile menu close button - added visually-hidden CSS for accessibility

- **fix**: Scroll-to-top button z-index conflicts with mobile menu backdrop



### 🚀 Features

- **feat**: Device orientation handling with orientationchange listener

- **feat**: Safe-area inset support for modern mobile devices

- **feat**: Improved mobile touch targets (44px minimum)



### 📱 Mobile Enhancements

- Enhanced landscape mode support for phones

- Better viewport height handling with dvh units
